...
public class InputProcessor {
	...
	static Map<String, Float> tokenIntegerValue = new HashMap<String, Float>(); // {pish=10.0, tegj=50.0, prok=5.0,
																				// glob=1.0}
	static Map<String, String> questionAndReply = new HashMap<String, String>(); // {how much is pish tegj glob glob ?,
																					// how many Credits is glob prok
																					// Iron ?}
	static ArrayList<String> missingValues = new ArrayList<String>(); // [glob glob Silver is 34 Credits, glob prok Gold
																		// is 57800 Credits, pish pish Iron is 3910
																		// Credits]
	static Map<String, Float> elementValueList = new HashMap<String, Float>(); // {Gold=14450.0, Iron=195.5,
																				// Silver=17.0}
